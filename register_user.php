...
<div class="signup-form">
    <form id="register-form" action="register_user.php" method="POST">
        ...
        <center><p style="color:red;"><?php if (isset($_GET['error'])) {
                    echo $_GET['error'];
                } ?></p></center>
        ...
        <div class="form-group">
            <input type="phone" class="form-control" name="phone" pattern="[0-9]*" placeholder="7022015320"
                   required="required">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            <label class="checkbox-inline"><input type="checkbox" required="required"> I accept the <a
                        href="T&C.html">Terms of Use &amp; Privacy Policy</a></label>
        </div>
        <div class="form-group">
